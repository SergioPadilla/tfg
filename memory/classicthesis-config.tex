...
% ****************************************************************************************************
\newcommand{\myTitle}{Problema isoperimétrico en el espacio y representación de información difusa en base de datos NoSQL\xspace}
\newcommand{\mySubtitle}{Resolución problema isoperímetrico y propuesta MongoDB\xspace}
